...
import edu.uw.tcss450.group6App.databinding.FragmentBlogCardBinding;

public class BlogRecyclerViewAdapter extends
        RecyclerView.Adapter<BlogRecyclerViewAdapter.BlogViewHolder>{

    //Store the expanded state for each List item, true -> expanded, false -> not
    private final Map<edu.uw.tcss450.group6App.ui.blog.BlogPost, Boolean> mExpandedFlags;


    //Store all of the blogs to present
    private final List<edu.uw.tcss450.group6App.ui.blog.BlogPost> mBlogs;
    public BlogRecyclerViewAdapter(List<edu.uw.tcss450.group6App.ui.blog.BlogPost> items) {
        this.mBlogs = items;
    ...
    public class BlogViewHolder extends RecyclerView.ViewHolder {
        ...
        private edu.uw.tcss450.group6App.ui.blog.BlogPost mBlog;
        ...
        private void displayPreview() {
            if (mExpandedFlags.get(mBlog)) { // binding.textPreview.getVisibility() == View.GONE // og line
        ...
        void setBlog(final edu.uw.tcss450.group6App.ui.blog.BlogPost blog) {
            mBlog = blog;
