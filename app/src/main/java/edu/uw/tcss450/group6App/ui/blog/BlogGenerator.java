...
public final class BlogGenerator {
    ...
    private static final edu.uw.tcss450.group6App.ui.blog.BlogPost[] BLOGS;
    public static final int COUNT = 20;


    static {
        BLOGS = new edu.uw.tcss450.group6App.ui.blog.BlogPost[COUNT];
        for (int i = 0; i < BLOGS.length; i++) {
            BLOGS[i] = new edu.uw.tcss450.group6App.ui.blog.BlogPost
    ...
    public static List<edu.uw.tcss450.group6App.ui.blog.BlogPost> getBlogList() {
        return Arrays.asList(BLOGS);
    }

    public static edu.uw.tcss450.group6App.ui.blog.BlogPost[] getBLOGS() {
